...
CloudflareApps.siteId = "874f1b9699015c34c5b5a9fdbe0c6430";
...
CloudflareApps.installs["_JYNwJj-yBEC"] = {
    appId: "lMxPPXVOqmoE",
    scope: {}
};;
CloudflareApps.installs["_JYNwJj-yBEC"].options = {
    "id": "UA-66678144-1",
    "social": true
};;
if (CloudflareApps.matchPage(CloudflareApps.installs['_JYNwJj-yBEC'].URLPatterns)) {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['_JYNwJj-yBEC'].URLPatterns)) {
    (function() {
        var options = CloudflareApps.installs['_JYNwJj-yBEC'].options
